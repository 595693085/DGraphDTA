...
for dataset in datasets:
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if val < best_mse:
            ...
            print('Mse improved at epoch ', best_epoch, '; best_valid_mse', best_mse, model_st, dataset)
        else:
            print('No improvement since epoch ', best_epoch, '; best_valid_mse', best_mse, model_st, dataset)
